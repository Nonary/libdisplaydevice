...
TEST_S(SingleDisplayConfiguration) {
  ...
  using Rat = display_device::Rational;
  EXPECT_EQ(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}));
  EXPECT_EQ(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, Rat {1, 1}, display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, Rat {1, 1}, display_device::HdrState::Disabled}));
  EXPECT_NE(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, Rat {1, 1}, display_device::HdrState::Disabled}));
  EXPECT_NE(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"0", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}));
  EXPECT_NE(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsurePrimary, {{1, 1}}, 1., display_device::HdrState::Disabled}));
  EXPECT_NE(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 0}}, 1., display_device::HdrState::Disabled}));
  EXPECT_NE(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1.1, display_device::HdrState::Disabled}));
  EXPECT_NE(display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Disabled}), display_device::SingleDisplayConfiguration({"1", Profile::Primary, DevicePrep::EnsureActive, {{1, 1}}, 1., display_device::HdrState::Enabled}));
}
